# Phase 2 Leakage Validation Report
...
| Check | Count |
|---|---:|
| Future competitor observations used | 0 |
| Future behavioral events used | 0 |
| Same-day date-only sales used | 0 |
| Future sales used | 0 |
| Future price intervals used | 0 |
| Stale promotions treated active | 0 |
| Historical inventory features | 0 |
